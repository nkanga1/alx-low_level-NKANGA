...
tasks. 1	Write a function that executes a function given as a parameter on each element of an array.

tasks. 2	Write a function that searches for an integer.

tasks. 3	Write a program that performs simple operations.

tasks. 4	Write a program that prints the opcodes of its own main function.
